...
public class SimulationController implements PropertyChangeListener {
    ...
    public void propertyChange(PropertyChangeEvent arg0) {
        ...
        if (propName.equals(Model.EVENT_SIMULATION_DONE)) {
            view.updateTab("Simulation " + model.simulationNo, model.getSimulationResult(), model.outputProtein, model.currentLoadedSBGate, model.fileChooser);            
        }
        
        if (propName.equals(Model.EVENT_STOP_SIMULATION)) {
            view.removeTab("Simulation " + model.simulationNo);
        }
    }
}
