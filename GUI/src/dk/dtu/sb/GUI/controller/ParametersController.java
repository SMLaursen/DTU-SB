...
public class ParametersController implements PropertyChangeListener {
    ...
    private void setupView() {
        parametersPanel.simulations.setValue(model.parameters
                .getSimIterations());
        ...
        parametersPanel.outSteps
                .setValue(model.parameters.getOutputStepCount());
    ...
    private void setUpViewEvents() {
        parametersPanel.simulations.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                model.parameters
                        .setSimIterations((Integer) parametersPanel.simulations
                                .getValue());
            }
        });
        ...
        parametersPanel.stoptime.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                model.parameters
                        .setSimStoptime((Integer) parametersPanel.stoptime
                                .getValue());
            }
        });
        ...
        parametersPanel.timeout.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                model.parameters
                        .setSimMaxIterTime((Integer) parametersPanel.timeout
                                .getValue());
            }
        });
        ...
        parametersPanel.outSteps.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                model.parameters
                        .setOutputStepCount((Integer) parametersPanel.outSteps
                                .getValue());
            }
        });
        ...
        parametersPanel.threshold.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                model.parameters
                        .setSimThreshold((Double) parametersPanel.threshold
                                .getValue());
            }
        });
        ...
        parametersPanel.cores.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                model.parameters
                        .setSimNoOfThreads((Integer) parametersPanel.cores
                                .getValue());
            }
        });
    ...
    public void propertyChange(PropertyChangeEvent arg0) {
            ...
            if (model.currentLoadedModel == Model.CURRENT_MODEL_LIBRARY) {
                ...
                for (String protein : model.getSPN().getInitialMarkings()
                    ...
                    if (model.inputProteins.contains(protein)) {
                        markings.put(protein, model.getSPN()
                                .getInitialMarkings().get(protein));
                    }
                }
            }
        ...
        if (propName.equals(Model.EVENT_SIMULATION_DONE)
                || propName.equals(Model.EVENT_STOP_SIMULATION)) {
            parametersPanel.stopSimButton.setEnabled(false);
            parametersPanel.simButton.setEnabled(true);
        }
